        ...
        public class PageManager : IReviewComment
        {
            ...
            public static string GetReviewToastMarkup(PortalSettings PortalSettings)
            {
                ...
                if (State != null)
                {
                    ...
                    string ReviewChangeFunction = !ShowReview ? "ConfirmReviewChange('" + FirstStateName + "');" : "$('.vj-cv-canvas__frames').removeClass('lockcanvas'); VJIsLocked='False'; $('.toast-close-button').click();";
